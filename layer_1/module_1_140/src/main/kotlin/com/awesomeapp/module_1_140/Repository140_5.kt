...
class Repository140_5 @Inject constructor(
    ...
    private val api13: Api24_6,
    private val api14: Api12_6,
    private val api15: Api16_6,
    private val api16: Api56_6,
    private val api17: Api80_6,
    private val api18: Api48_6,
    private val api19: Api28_6
) {
    suspend fun getData(): String = withContext(Dispatchers.IO) {
        api0.fetchData() + api1.fetchData() + api2.fetchData() + api3.fetchData() + api4.fetchData() + api5.fetchData() + api6.fetchData() + api7.fetchData() + api8.fetchData() + api9.fetchData() + api10.fetchData() + api11.fetchData() + api12.fetchData() + api13.fetchData() + api14.fetchData() + api15.fetchData() + api16.fetchData() + api17.fetchData() + api18.fetchData() + api19.fetchData()
    }
}